package org.getback4j.getback.configuration.serialization;
...
public class ConfigurationSerialization {
    ...
    protected ConfigurationSerializable deserializeViaMethod(Method method, Map<String, ?> args) {
        try {
            ...
            if (result == null) {
                Logger.getLogger(ConfigurationSerialization.class.getName()).log(Level.SEVERE, "Could not call method ''{0}'' of {1} for deserialization: method returned null", new Object[]{method.toString(), clazz});
            } else {
                return result;
            }
    ...
    public static ConfigurationSerializable deserializeObject(Map<String, ?> args) {
        ...
        if (args.containsKey(SERIALIZED_TYPE_KEY)) {
            try {
                ...
                GetBack.getInstance().getLogger().log("Error deserializing object: "+ex.getMessage());
            }
        } else {
