...
public class HttpMirror {
                        ...
                        if (request != null) {
                            ...
                            if (request.startsWith("GET")) {
                                ...
                                if (req.contains("..") || req.contains("/.ht") || req.endsWith("~")) {
                                    ...
                                    System.out.println("current req: " + req);
     ...
     *
     * <strong>Note:</strong> Do not replace with a multi-catch. NPE's can/will
     * happen and a NPE will not be included in the multi-catch by default.
     */
